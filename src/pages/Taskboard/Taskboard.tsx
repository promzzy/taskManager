...
const Taskboard: FC<TaskBoardProps> = ({ myTeam = [], task = [] }) => {
  const { handleEditTask, createTask, addMember, editMember, deleteTask } =
    useTaskboard();
  ...
  return (
    <div className={classes.boardRoot}>
      ...
      <button onClick={createTask} className={classes.newTaskBtn}>
        + New task
      </button>
    </div>
  );
